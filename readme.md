...
Sumz is an open-source web application that simplifies lengthy
articles into clear and concise summaries using **OpenAI GPT-4**. With
a minimalistic and responsive UI, Sumz helps users read faster and
grasp key points efficiently, just by pasting the article URL.

![Screenshot 2025-05-17
215834](https://github.com/user-attachments/assets/0f9f758b-2c30-46a6-888d-ba3e047987b3)
